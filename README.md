...
├── 📄 auth.html               # Регистрация/авторизация ⭐⭐⭐
├── 📄 feedback.html           # Отзывы на товары ⭐⭐⭐
...
├── 📄 cart.js                 # JavaScript для корзины ⭐⭐ (обновлен)
├── 📄 auth.js                 # JavaScript для авторизации ⭐⭐⭐
├── 📄 feedback.js             # JavaScript для отзывов ⭐⭐⭐
├── 📄 admin.js                # JavaScript для админ-панели ⭐⭐⭐
├── 📄 db.json                 # База данных JSON Server ⭐ (обновлен)
├── 📄 package.json            # Конфигурация npm
├── 📁 images/                 # Изображения товаров
└── 📚 Документация/
    ├── README-SERVER.md                    # Руководство по JSON Server
    ├── ЛАБОРАТОРНАЯ_РАБОТА_8.md           # Полная документация Лаб #8 ⭐⭐⭐
...
### ✅ Лабораторная #8 - Система управления с авторизацией

**Новые страницы:**

1. **auth.html / auth.js** - Регистрация и авторизация
   - Форма входа и регистрации
   - Валидация данных
   - Сохранение сессии пользователя
   - Разделение ролей (admin/customer)

2. **feedback.html / feedback.js** - Отзывы на товары
   - Форма добавления отзыва с рейтингом (1-5 звезд)
   - Список всех отзывов
   - Фильтрация по товару и рейтингу
   - Требуется авторизация

3. **admin.html / admin.js** - Админ-панель
...
**Обновленная база данных (db.json):**
- **users** - пользователи и их роли
- **feedback** - отзывы на товары
- **orders** - история заказов

**Обновленная логика:**
- cart.js теперь сохраняет заказы в коллекцию orders
- Добавлена работа с пользовательской сессией
- Реализована система ролей и доступов

**Тестовые аккаунты:**
```
Администратор:
Email: admin@boostedusa.com
Пароль: admin123
...
**Реализованные требования:**
- ✅ Три новые коллекции в db.json
- ✅ Сохранение заказов при покупке
- ✅ Система регистрации/авторизации
- ✅ Форма отзывов на товары
- ✅ Полнофункциональная админ-панель
- ✅ Валидная и семантическая верстка
- ✅ Адаптивный дизайн (Desktop/Tablet/Mobile)
- ✅ Единый стиль с лендингом

📖 **Подробная документация:** См. `ЛАБОРАТОРНАЯ_РАБОТА_8.md`

---

**Дата выполнения:** Октябрь 2025  
**Автор:** Lab 8 - User Management System  
